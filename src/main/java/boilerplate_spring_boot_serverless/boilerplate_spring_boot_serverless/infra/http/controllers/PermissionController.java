package boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.http.controllers;

import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.permission.create.CreatePermissionUseCaseInputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.permission.delete.DeletePermissionUseCaseInputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.permission.findAll.FindAllPermissionsUseCaseOutputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.permission.findById.FindPermissionByIdUseCaseInputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.permission.findById.FindPermissionByIdUseCaseOutputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.permission.update.UpdatePermissionUseCaseInputDto;
...
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.permission.CreatePermissionUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.permission.DeletePermissionUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.permission.FindAllPermissionsUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.permission.FindPermissionByIdUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.permission.UpdatePermissionUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.helpers.BaseResponse;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.http.validators.permission.CreatePermissionValidator;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.http.validators.permission.UpdatePermissionValidator;
