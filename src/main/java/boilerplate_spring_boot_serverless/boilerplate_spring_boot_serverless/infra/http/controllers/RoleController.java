...
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.role.delete.DeleteRoleUseCaseInputDto;
...
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.role.findById.FindRoleByIdUseCaseInputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.role.findById.FindRoleByIdUseCaseOutputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.role.syncRoleWithPermissions.SyncRoleWithPermissionsUseCaseInputDto;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.dtos.useCases.role.update.UpdateRoleUseCaseInputDto;
...
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.role.DeleteRoleUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.role.FindAllRolesUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.role.FindRoleByIdUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.role.SyncRoleWithPermissionsUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.application.useCases.role.UpdateRoleUseCase;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.helpers.BaseResponse;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.http.validators.role.CreateRoleValidator;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.http.validators.role.SyncRoleWithPermissionsValidator;
import boilerplate_spring_boot_serverless.boilerplate_spring_boot_serverless.infra.http.validators.role.UpdateRoleValidator;
